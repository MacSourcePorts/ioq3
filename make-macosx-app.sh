...
if [ "MACOSX_BUNDLE_TYPE" == "universal2" ]; then
	cp code/libs/macosx-universal2/*.dylib "${BUILT_PRODUCTS_DIR}/${EXECUTABLE_FOLDER_PATH}"
else
	cp code/libs/macosx-universal/*.dylib "${BUILT_PRODUCTS_DIR}/${EXECUTABLE_FOLDER_PATH}"
fi
